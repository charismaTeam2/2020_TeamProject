                ...
                <TableContainer component={Paper}>
                    ...
                    <TableHead>
                        <TableRow>
                            ...
                            <TableCell align="right">거래글</TableCell>
                    ...
                    {this.state.deal.map(c => {
                        return(
                        <Deal_table key={c.deal_number} number={c.deal_number} user={c.user_id} p_number={c.product_number} count={c.deal_count} price={c.deal_all_price} stat={c.deal_stat} date={c.deal_accept} />
                        );
                    })}
                    </Table>
                </TableContainer>
